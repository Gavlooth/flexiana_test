...
var i_47279 = (0);
while(true){
if((i_47279 < arr.length)){
(arr[i_47279] = null);

var G__47281 = (i_47279 + (1));
i_47279 = G__47281;
continue;
} else {
}
...
var i_47299 = (self__.level + (1));
while(true){
if((i_47299 <= (new_level + (1)))){
(update[i_47299] = self__.header);

var G__47304 = (i_47299 + (1));
i_47299 = G__47304;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_47310 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_47310[i]));
} else {
x__$2.forward.push((((i < links_47310.length))?(links_47310[i]):null));
}

if((i < links_47310.length)){
(links_47310[i] = x__$2);
} else {
links_47310.push(x__$2);
}
...
var i_47327 = (0);
while(true){
if((i_47327 <= self__.level)){
var links_47329 = (update[i_47327]).forward;
if((x__$1 === (((i_47327 < links_47329.length))?(links_47329[i_47327]):null))){
(links_47329[i_47327] = (x__$1.forward[i_47327]));

var G__47330 = (i_47327 + (1));
i_47327 = G__47330;
continue;
} else {
var G__47331 = (i_47327 + (1));
i_47327 = G__47331;
continue;
}
} else {
