...
var G__47568 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__47568;
continue;
} else {
return ch;
...
var vec__47532 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47532,(0),null);
return (match === s);
});
...
var len__4864__auto___47574 = arguments.length;
var i__4865__auto___47575 = (0);
while(true){
if((i__4865__auto___47575 < len__4864__auto___47574)){
args__4870__auto__.push((arguments[i__4865__auto___47575]));

var G__47576 = (i__4865__auto___47575 + (1));
i__4865__auto___47575 = G__47576;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq47552){
...
return (function() { 
var G__47577__delegate = function (rdr,_){
...
var G__47577 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__47579__i = 0, G__47579__a = new Array(arguments.length -  1);
while (G__47579__i < G__47579__a.length) {G__47579__a[G__47579__i] = arguments[G__47579__i + 1]; ++G__47579__i;}
  _ = new cljs.core.IndexedSeq(G__47579__a,0,null);
} 
return G__47577__delegate.call(this,rdr,_);};
G__47577.cljs$lang$maxFixedArity = 1;
G__47577.cljs$lang$applyTo = (function (arglist__47582){
var rdr = cljs.core.first(arglist__47582);
var _ = cljs.core.rest(arglist__47582);
return G__47577__delegate(rdr,_);
});
