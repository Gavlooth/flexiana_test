...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__45463_SHARP_,p2__45462_SHARP_){
return p2__45462_SHARP_.toUpperCase();
}));
...
var G__45468 = o;
helix.impl.props.goog$module$goog$object.set(G__45468,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__45483 = cljs.core.rest(m);
var G__45484 = (function (){var entry = cljs.core.first(m);
...
var G__45472 = o1;
helix.impl.props.goog$module$goog$object.extend(G__45472,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45473_SHARP_){
if(cljs.core.map_QMARK_(p1__45473_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__45473_SHARP_);
} else {
return p1__45473_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__45493 = cljs.core.rest(m);
var G__45494 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__45502 = cljs.core.rest(m);
var G__45503 = (function (){var entry = cljs.core.first(m);
