...
var i_45511 = (0);
while(true){
if((i_45511 < arr.length)){
(arr[i_45511] = null);

var G__45516 = (i_45511 + (1));
i_45511 = G__45516;
continue;
} else {
}
...
var i_45563 = (self__.level + (1));
while(true){
if((i_45563 <= (new_level + (1)))){
(update[i_45563] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_45567 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_45567[i]));
} else {
x__$2.forward.push((((i < links_45567.length))?(links_45567[i]):null));
}

if((i < links_45567.length)){
(links_45567[i] = x__$2);
} else {
links_45567.push(x__$2);
}
...
var i_45578 = (0);
while(true){
if((i_45578 <= self__.level)){
var links_45579 = (update[i_45578]).forward;
if((x__$1 === (((i_45578 < links_45579.length))?(links_45579[i_45578]):null))){
(links_45579[i_45578] = (x__$1.forward[i_45578]));

var G__45580 = (i_45578 + (1));
i_45578 = G__45580;
continue;
} else {
var G__45581 = (i_45578 + (1));
i_45578 = G__45581;
continue;
}
} else {
...
var G__45590 = nx;
var G__45591 = (level__$1 - (1));
x = G__45590;
level__$1 = G__45591;
continue;
} else {
var G__45592 = x;
var G__45593 = (level__$1 - (1));
x = G__45592;
level__$1 = G__45593;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__45599 = nx;
var G__45600 = (level__$1 - (1));
x = G__45599;
level__$1 = G__45600;
continue;
} else {
var G__45601 = x;
var G__45602 = (level__$1 - (1));
x = G__45601;
level__$1 = G__45602;
continue;
}
