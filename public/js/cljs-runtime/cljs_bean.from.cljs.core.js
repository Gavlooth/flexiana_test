...
var G__44986 = cljs.core.next(xs);
var G__44987 = cljs.core.next(ys);
xs = G__44986;
ys = G__44987;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__44842 = val;
var G__44843 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__44842,G__44843) : f.call(null,G__44842,G__44843));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__44845 = val__$1;
var G__44847 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__44845,G__44847) : f.call(null,G__44845,G__44847));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__44853 = val__$1;
var G__44854 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__44853,G__44854) : f.call(null,G__44853,G__44854));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__45009 = cljs.core.next(es);
var G__45010 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__45009;
tcoll__$1 = G__45010;
continue;
} else {
...
var G__45015 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__45016 = cljs.core.next(es);
ret = G__45015;
es = G__45016;
continue;
} else {
